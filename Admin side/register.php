			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner register_form_inner">
						...
						<form class="row login_form"  id="register_form" method="post" action="form\register.php">
              ...
              <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button type="submit" value="ok" name="ok" class="button button-register w-100">Register</button>
							</div>
						</form>
					</div>
				</div>
